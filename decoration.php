...
<head>
    ...
    <title>Decoration & Lightning - NikahYuk</title>
    <!-- Bootstrap -->
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">Paket Decoration & Lightning</h1>
    ...
    <div class="container">
        <div class="container">
			<?php
				...
				$sql="SELECT * FROM paket_category WHERE paket_nm LIKE '%Decoration%'";
			...
			<?php
				...
				$sql="SELECT * FROM paket_category WHERE paket_nm LIKE '%Dekorasi%'";
				$result = mysqli_query($user->db, $sql);
				if($result)
				{
					if(mysqli_num_rows($result) > 0)
			...
			<?php
				...
				$sql="SELECT * FROM paket_category WHERE paket_nm LIKE '%Light%'";
				$result = mysqli_query($user->db, $sql);
				if($result)
				{
					if(mysqli_num_rows($result) > 0)
			...
			<?php
				...
				$sql="SELECT * FROM paket_category WHERE paket_nm LIKE '%Cahaya%'";
				$result = mysqli_query($user->db, $sql);
				if($result)
				{
					if(mysqli_num_rows($result) > 0)
