            ...
            if(mysqli_num_rows($result) > 0)
            {
                while($row = mysqli_fetch_array($result))
                {
                   ...
                   echo "
                            ...
                            <div class='col-md-4'></div>
                            <div class='col-md-5 well'>
                                <h4>".$row2['paket_nm']."</h4><hr>
                                <h6>Stok: ".$row2['available']." Tersedia</h6>
                                <h6>Facilities: ".$row2['facility']."</h6>
                                <h6>Harga: ".$row2['price']."</h6>
                            </div>
                            <div class='col-md-3'>
                                <a href='./booknow.php?paketname=".$row2['paket_nm']."'><button class='btn btn-primary button'>Book Now</button></a>
                            </div>   
                            </div>
