...
$paket_cat=$_GET['paketname'];

$sql="SELECT * FROM paket_category WHERE paket_nm='$paket_cat'";
...
{ 
    extract($_REQUEST); 
    $result=$user->edit_paket_cat($paket_nm, $paket_qty, $facility, $price, $paket_cat);
    if($result)
    {
...
<head>
    ...
    <title>Edit Paket NikahYuk - Admin Panel</title>
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
			<a class="navbar-brand" href="#">
				Edit Paket NikahYuk - Admin Panel
			</a>
            ...
            <div class="col-12">
                <!-- Main Content -->
                    ...
                    <div class="side-body">
						...
						<h2>Edit Paket/Item</h2>
						<hr>
						<form action="" method="post" name="paket_category">
							<div class="form-group">
								<label for="paket_nm">Nama Paket/Item:</label>
								<input type="text" class="form-control" name="paket_nm" value="<?php echo $row['paket_nm'] ?>" required>
							</div>
							 <div class="form-group">
								<label for="qty">Jumlah Item/Paket:</label>&nbsp;
								<input type="text" class="form-control" name="paket_qty" value="<?php echo $row['paket_qty'] ?>" required>
							</div>
							<div class="form-group">
								<label for="Facility">Fasilitas/Detail</label>
								<textarea id="ckEditor" class="form-control" name="facility"><?php echo $row['facility'] ?></textarea>
							</div>
						   <div class="form-group">
