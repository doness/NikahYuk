								...
								while($row = mysqli_fetch_array($result))
								{
									...
									echo "
											<div class='card'>
											  ...
											  <div class='card-body'>
												<h5 class='card-title'>Tersedia: ".$row['available']." dari ".$row['paket_qty']." Paket/Item <br> Dipesan: ".$row['booked']." Orang</h5>
												<h5 class='card-title'>Harga: ".$row['price']."</h5><br/>
												<a href='./booknow.php?paketname=".$row['paket_nm']."' class='btn btn-primary'>Book Now!</a>
											  </div>
											</div><br>																
										 ";
