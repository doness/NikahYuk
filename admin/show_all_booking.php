            ...
            <div class="col-12">
                <!-- Main Content -->
                    ...
                    <div class="side-body">
						...
						$sql="SELECT * FROM paket WHERE book='true'";
								...
								while($row = mysqli_fetch_array($result))
								{
									...
									echo "
											<div class='card'>
											  ...
											  <div class='card-body'>
												<h5 class='card-title'>Checkin: ".$row['checkin']." <br/>Checkout: ".$row['checkout']."</h5>
												<p class='card-text'>Name: ".$row['name']."</p>
												<p class='card-text'>Phone: ".$row['phone']."</p>
												<p class='card-text'>Booking Condition: ".$row['book']."</p><br/>
												<a href='edit_all_booking.php?id=".$row['paket_id']."' class='btn btn-primary'>Edit Booking</a>
											  </div>
											</div><br>																
										 ";
