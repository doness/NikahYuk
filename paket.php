		  ...
		  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
			  ...
			  <li class="nav-item active">
				<a class="nav-link" href="paket.php">Paket Pernikahan <span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item">
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">Paket Pernikahan</h1>
							...
							echo "  <div class='row'>
										...
										<div class='col-md-10'>
											<div class='card mb-4 box-shadow'>
												...
												<img class='card-img-top' style='width: 100%; display: block;' src='images/woz.jpg' data-holder-rendered='true'>
												<div class='card-body'>
